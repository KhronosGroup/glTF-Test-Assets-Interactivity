...
| event/receiveref not null | TestResult_event/refs_event/receiveref not null | 6 | False
| event/onStarttwo nodes same ref | TestResult_event/refs_event/onStarttwo nodes same ref | 8 | True
| event/onTicktwo nodes same ref | TestResult_event/refs_event/onTicktwo nodes same ref | 10 | True
